...
public class PersonService extends BaseService<User> {
	...
	public ResponseEntity<?> savePerson(Person person, boolean isCreate) throws PgpException {
		...
		if (isCreate) {
			Person found = personRepo.findByDocumentIdIgnoreCase(person.getDocumentId());
			if (found != null) {
				return new ResponseEntity<ErrorControl>(
...
//	public User userCreate(User crtUser, String randomPassword) {
//		String encodedPassword = passwordEncoder().encode(randomPassword);
//		crtUser.setPassword(encodedPassword);
//		crtUser.setHasTempPassword(true);
//		return crtUser;
//	}
