...
public interface PersonRepo extends JpaRepository<Person, Long> {
	public Optional<Person> findByDocumentIdIgnoreCaseAndIsDeletedFalseAndStatusTrue(String documentId);
	public Optional<Person> findByDocumentIdIgnoreCase(String documentId);
	...
	public Page<Person> findPersonBySearch(@Param("documentId") String documentId, @Param("name") String name,
